  ...
  <div class="page-wrapper">
    ...
    <div class="page-body">
      ...
      <div class="card">
        ...
        <form class="form-material" id="addform" action="{{ route('salary.save') }}" method="POST">
                                    @csrf
            ...
            <div class="row">
               ...
               <input type="month" id="month" name="month" class="form-control">
                ...
                <div class="form-group form-default">
                 <select name="emp_id" class="form-control" id="emp_id">
                     ...
                     <option value="{{$emplist->id}}">{{$emplist->first_name}}</option>
                     @endforeach
                 </select>
                  <span class="form-bar"></span>
                ...
                <span id="error_emp" class="text-danger"></span>
                          ...
                          <div class="row">
                                            <div class="col-md-6">
                <div class="form-group form-default">
                  <input type="text" name="no_of_working_days" id="no_of_working_days" value=""  class="form-control">
                  <span class="form-bar"></span>
              ...
              <div class="col-md-6">
                <div class="form-group form-default">
                  <input type="text" name="salary_per_day" id="salary_per_day" value=""  class="form-control">
                  <span class="form-bar"></span>
            ...
            <span id="error_salary_per_day" class="text-danger"></span>
             ...
             <div class="row">
                                            <div class="col-md-6">
                <div class="form-group form-default">
                  <input type="text" name="total_salary" id="total_salary" value=""  class="form-control">
                  <span class="form-bar"></span>
