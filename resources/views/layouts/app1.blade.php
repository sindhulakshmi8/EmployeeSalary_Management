            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <div class="top-user-profile-icon top-user-profile-jq1">
                        <figure class="user-profile-icon">
                            <img src="{{ asset('admin/images/business-and-trade.svg') }}"/>
                        </figure>
                        <span> </span> <i class="fas fa-chevron-down"></i>
                        <div class="profile-dropdown profile-dropdown-jq1">
                            <ul>
                                <li>
